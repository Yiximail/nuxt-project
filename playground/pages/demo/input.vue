  ...
  <div>
    ...
    >
      ...
      <div class="">
        ...
        <v-fieldset
          ...
          :type="type"
          :size="size"
          :active-offset-x="type === 'outline' ? undefined : '16px'"
          offset-x="calc(0.5rem + 16px)"
          :always-show="alwaysShow"
        >
          <v-icon
            icon="mdi:search"
            class="text-natural-500 dark:text-natural-400"
          />
          <v-input
            v-model="inputValue"
            :placeholder="placeholder"
    ...
    <v-form>
      <v-form-item label="类型">
        <v-radio-button v-model="inputType" value="text">
          文本
        </v-radio-button>
        <v-radio-button v-model="inputType" value="password">
          密码
        </v-radio-button>
      </v-form-item>
