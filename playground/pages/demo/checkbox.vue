<template>
  <div>
    <div
      class="border-2 border-natural-300 dark:border-natural-700 rounded p-5 mb-2"
    >
    ...
    <v-form>
      <v-form-item label="标签文字" fieldset="outline">
      ...
      <div class="flex gap-10">
        ...
        <v-form-item label="半选状态">
          <v-checkbox v-model="indeterminate" />
        </v-form-item>
