<template>
  <div>
    ...
    >
      <v-button color="primary" @click="showNotification('primary')">
        primary
      </v-button>
      <v-button color="success" @click="showNotification('success')">
        success
      </v-button>
      <v-button color="warning" @click="showNotification('warning')">
        warning
      </v-button>
